	...
	return (
		<>
			<nav
				...
				className={`fixed left-1/2 backdrop-blur-xl -translate-x-1/2 bottom-2 gap-2 rounded-xl border p-2 border-slate-600 transition-all duration-200 hidden md:flex ${visible ? 'opacity-100' : 'opacity-0 translate-y-24'}`}
			>
